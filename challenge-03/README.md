...
*/
var pessoa = { nome: "Maria", sobrenome: "Souza", sexo: "feminino", idade: 20, altura: 1.50, peso: 55, andando: function(){ "falso";}, caminhouQuantosMetros: 0}
...
*/
pessoa.andar = function(x){ pessoa.caminhouQuantosMetros += x ; pessoa.andando = "verdadeiro";}
...
pessoa.mostraQuantosMetros = function() {
...
pessoa.apresentacao = function() {
  return pessoa.qualOSexo() + pessoa.nome + " " + pessoa.sobrenome + "," + pessoa.mostrarIdade() + pessoa.altura + "m , meu peso é " + pessoa.peso + " e, só hoje, eu já caminhei " + pessoa.mostraQuantosMetros();
}
