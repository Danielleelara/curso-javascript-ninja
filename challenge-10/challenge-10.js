(function () {
         ...
         */
            ...
            */
            function showOperationMessage(operador, num1, num2) {
                if (!!operation[operador]) {
                    return ('A operação ' + num1 + operador + num2 + ' = ' + operation[operador](num1, num2));
                }

            }
            console.log(showOperationMessage('*', 40, 10));
            ...
            */
            ...
            console.log(showErrorMessage('2'));
            ...
            */
            operationSignal = 2;
            var sum = calculator(operationSignal);
            console.log(showErrorMessage(sum));
        })();
