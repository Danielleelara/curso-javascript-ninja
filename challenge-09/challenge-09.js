(function(){
         console.log(
            ...
            */
            var subtraction = calculadora(10, 20);
                var subtração = subtraction(function(x, y) {
                return x - y;
                });

            var multiplication = calculadora(300,150);
                var multiplicação = multiplication(function(x,y){
                    return x * y;
                });    

            var division = calculadora(300,150);
                var divisão = division(function(x,y){
                    return x / y;
                });     

            var mod = calculadora(300,120);
                var porcentagem = mod(function(x,y){
                    return x % y;
                });      
            ...
            */
            ...
            console.log( 'O resto da divisão é:' + porcentagem);
            // );
